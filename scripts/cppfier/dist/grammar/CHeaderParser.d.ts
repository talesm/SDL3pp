...
export declare class CHeaderParser extends Parser {
    ...
    static readonly RULE_directive = 2;
    static readonly RULE_externC = 3;
    static readonly RULE_globalVar = 4;
    static readonly RULE_functionDecl = 5;
    static readonly RULE_functionDef = 6;
    static readonly RULE_aliasDef = 7;
    static readonly RULE_unionDef = 8;
    static readonly RULE_enumDef = 9;
    static readonly RULE_structDecl = 10;
    static readonly RULE_structDef = 11;
    static readonly RULE_callbackDef = 12;
    static readonly RULE_compileTimeAssert = 13;
    static readonly RULE_inline = 14;
    static readonly RULE_block = 15;
    static readonly RULE_group = 16;
    static readonly RULE_indexing = 17;
    static readonly RULE_stm = 18;
    static readonly RULE_expr = 19;
    static readonly RULE_word = 20;
    static readonly RULE_punct = 21;
    static readonly RULE_enumBody = 22;
    static readonly RULE_enumItem = 23;
    static readonly RULE_structBody = 24;
    static readonly RULE_structItem = 25;
    static readonly RULE_structVar = 26;
    static readonly RULE_structCallback = 27;
    static readonly RULE_unionInlineType = 28;
    static readonly RULE_id = 29;
    static readonly RULE_type = 30;
    static readonly RULE_typeEl = 31;
    static readonly RULE_signature = 32;
    static readonly RULE_attribute = 33;
    static readonly RULE_doc = 34;
    static readonly RULE_trailingDoc = 35;
...
export declare class DeclContext extends ParserRuleContext {
    ...
    globalVar(): GlobalVarContext | undefined;
    ...
    structDecl(): StructDeclContext | undefined;
...
export declare class GlobalVarContext extends ParserRuleContext {
    type(): TypeContext;
    id(): IdContext[];
...
export declare class StructDeclContext extends ParserRuleContext {
    STRUCT(): TerminalNode;
    id(): IdContext;
    SEMI(): TerminalNode;
    attribute(): AttributeContext[];
...
export declare class AttributeContext extends ParserRuleContext {
    ...
    SDL_ACQUIRE(): TerminalNode | undefined;
    SDL_RELEASE(): TerminalNode | undefined;
    SDL_ALLOC_SIZE(): TerminalNode | undefined;
    SDL_INOUT(): TerminalNode | undefined;
    VK_DEFINE_HANDLE(): TerminalNode | undefined;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
    enterRule(listener: CHeaderListener): void;
    exitRule(listener: CHeaderListener): void;
