...
export declare class CHeaderParser extends Parser {
    ...
    static readonly RULE_callbackDef = 8;
    static readonly RULE_inline = 9;
    static readonly RULE_block = 10;
    static readonly RULE_group = 11;
    static readonly RULE_indexing = 12;
    static readonly RULE_stm = 13;
    static readonly RULE_word = 14;
    static readonly RULE_punct = 15;
    static readonly RULE_enumBody = 16;
    static readonly RULE_enumItem = 17;
    static readonly RULE_enumItemLast = 18;
    static readonly RULE_id = 19;
    static readonly RULE_type = 20;
    static readonly RULE_typeEl = 21;
    static readonly RULE_signature = 22;
    static readonly RULE_attribute = 23;
    static readonly RULE_doc = 24;
    static readonly RULE_trailingDoc = 25;
