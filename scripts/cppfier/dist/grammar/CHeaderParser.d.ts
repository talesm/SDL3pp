...
export declare class CHeaderParser extends Parser {
    ...
    static readonly CURLY_B = 21;
    static readonly CURLY_E = 22;
    static readonly ROUND_B = 23;
    static readonly ROUND_E = 24;
    static readonly SQUARE_B = 25;
    static readonly SQUARE_E = 26;
    static readonly COLON = 27;
    static readonly SEMI = 28;
    static readonly COMMA = 29;
    static readonly DOT = 30;
    static readonly STAR = 31;
    static readonly EQ = 32;
    static readonly PUNCT_EXTRA = 33;
