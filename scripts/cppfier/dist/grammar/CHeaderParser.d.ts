...
export declare class CHeaderParser extends Parser {
    ...
    static readonly CURLY_B = 27;
    static readonly CURLY_E = 28;
    static readonly ROUND_B = 29;
    static readonly ROUND_E = 30;
    static readonly SQUARE_B = 31;
    static readonly SQUARE_E = 32;
    static readonly COLON = 33;
    static readonly SEMI = 34;
    static readonly COMMA = 35;
    static readonly DOT = 36;
    static readonly STAR = 37;
    static readonly EQ = 38;
    static readonly ELLIPSIS = 39;
    static readonly PUNCT_EXTRA = 40;
    static readonly STRING = 41;
    ...
    static readonly RULE_structDef = 10;
    static readonly RULE_callbackDef = 11;
    static readonly RULE_compileTimeAssert = 12;
    static readonly RULE_inline = 13;
    static readonly RULE_block = 14;
    static readonly RULE_group = 15;
    static readonly RULE_indexing = 16;
    static readonly RULE_stm = 17;
    static readonly RULE_expr = 18;
    static readonly RULE_word = 19;
    static readonly RULE_punct = 20;
    static readonly RULE_enumBody = 21;
    static readonly RULE_enumItem = 22;
    static readonly RULE_structBody = 23;
    static readonly RULE_structItem = 24;
    static readonly RULE_structVar = 25;
    static readonly RULE_structCallback = 26;
    static readonly RULE_unionInlineType = 27;
    static readonly RULE_id = 28;
    static readonly RULE_type = 29;
    static readonly RULE_typeEl = 30;
    static readonly RULE_signature = 31;
    static readonly RULE_attribute = 32;
    static readonly RULE_doc = 33;
    static readonly RULE_trailingDoc = 34;
