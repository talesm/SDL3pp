...
export declare class CHeaderParser extends Parser {
    ...
    static readonly CURLY_B = 22;
    static readonly CURLY_E = 23;
    static readonly ROUND_B = 24;
    static readonly ROUND_E = 25;
    static readonly SQUARE_B = 26;
    static readonly SQUARE_E = 27;
    static readonly COLON = 28;
    static readonly SEMI = 29;
    static readonly COMMA = 30;
    static readonly DOT = 31;
    static readonly STAR = 32;
    static readonly EQ = 33;
    static readonly ELLIPSIS = 34;
    static readonly PUNCT_EXTRA = 35;
    static readonly STRING = 36;
    static readonly ID = 37;
    static readonly NUMBER = 38;
