...
#define SDL3PP_PROP_IOSTREAM_WINDOWS_HANDLE_POINTER                            \
  SDL_PROP_IOSTREAM_WINDOWS_HANDLE_POINTER

#define SDL3PP_PROP_IOSTREAM_STDIO_FILE_POINTER                                \
  SDL_PROP_IOSTREAM_STDIO_FILE_POINTER

#define SDL3PP_PROP_IOSTREAM_FILE_DESCRIPTOR_NUMBER                            \
  SDL_PROP_IOSTREAM_FILE_DESCRIPTOR_NUMBER

#define SDL3PP_PROP_IOSTREAM_ANDROID_AASSET_POINTER                            \
  SDL_PROP_IOSTREAM_ANDROID_AASSET_POINTER

#define SDL3PP_PROP_IOSTREAM_MEMORY_POINTER SDL_PROP_IOSTREAM_MEMORY_POINTER

#define SDL3PP_PROP_IOSTREAM_MEMORY_SIZE_NUMBER                                \
  SDL_PROP_IOSTREAM_MEMORY_SIZE_NUMBER

#define SDL3PP_PROP_IOSTREAM_DYNAMIC_MEMORY_POINTER                            \
  SDL_PROP_IOSTREAM_DYNAMIC_MEMORY_POINTER

#define SDL3PP_PROP_IOSTREAM_DYNAMIC_CHUNKSIZE_NUMBER                          \
