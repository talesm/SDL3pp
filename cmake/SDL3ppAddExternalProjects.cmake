...
if (SDL3PP_ENABLE_IMAGE)
  ...
  if (NOT TARGET SDL3_image::SDL3_image)
    ...
    include(${SDL3ImageExternal_SOURCE_DIR}/cmake/SDL3_imageConfig.cmake)
  endif()
...
if (SDL3PP_ENABLE_MIXER)
  ...
  if (NOT TARGET SDL3_mixer::SDL3_mixer)
    ...
    include(${SDL3MixerExternal_SOURCE_DIR}/cmake/SDL3_mixerConfig.cmake)
  endif()
...
if (SDL3PP_ENABLE_TTF)
  ...
  if (NOT TARGET SDL3_ttf::SDL3_ttf)
    ...
    include(${SDL3TTFExternal_SOURCE_DIR}/cmake/SDL3_ttfConfig.cmake)
  endif()
