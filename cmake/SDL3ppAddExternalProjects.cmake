...
elseif (WIN32)
  if (MSVC)
    set(SDL3_URL https://github.com/libsdl-org/SDL/releases/download/release-3.4.8/SDL3-devel-3.4.8-VC.zip)
  else ()
    set(SDL3_URL https://github.com/libsdl-org/SDL/releases/download/release-3.4.8/SDL3-devel-3.4.8-mingw.tar.gz)
  endif ()
else ()
  set(SDL3_URL https://github.com/libsdl-org/SDL/releases/download/release-3.4.8/SDL3-3.4.8.tar.gz)
endif ()
