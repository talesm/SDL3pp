...
elseif (WIN32)
  if (MSVC)
    set(SDL3_URL https://github.com/libsdl-org/SDL/releases/download/release-3.4.10/SDL3-devel-3.4.10-VC.zip)
  else ()
    set(SDL3_URL https://github.com/libsdl-org/SDL/releases/download/release-3.4.10/SDL3-devel-3.4.10-mingw.tar.gz)
  endif ()
else ()
  set(SDL3_URL https://github.com/libsdl-org/SDL/releases/download/release-3.4.10/SDL3-3.4.10.tar.gz)
endif ()
...
if (SDL3PP_ENABLE_IMAGE)
  ...
  elseif (WIN32)
    set(SDL3IMAGE_URL https://github.com/libsdl-org/SDL_image/releases/download/release-3.4.4/SDL3_image-devel-3.4.4-mingw.tar.gz)
  else ()
    set(SDL3IMAGE_URL https://github.com/libsdl-org/SDL_image/releases/download/release-3.4.4/SDL3_image-3.4.4.tar.gz)
  endif ()
