...
elseif (WIN32)
  if (MSVC)
    set(SDL3_URL https://github.com/libsdl-org/SDL/releases/download/release-3.4.16/SDL3-devel-3.4.16-VC.zip)
  else ()
    set(SDL3_URL https://github.com/libsdl-org/SDL/releases/download/release-3.4.16/SDL3-devel-3.4.16-mingw.tar.gz)
  endif ()
else ()
  set(SDL3_URL https://github.com/libsdl-org/SDL/releases/download/release-3.4.16/SDL3-3.4.16.tar.gz)
endif ()
...
if (NOT TARGET SDL3::SDL3)
  ...
  set(SDL3_DIR ${SDL3External_SOURCE_DIR}/cmake CACHE PATH "Path to SDL3 source directory" FORCE)
...
if (SDL3PP_ENABLE_IMAGE)
  ...
  elseif (WIN32)
    set(SDL3IMAGE_URL https://github.com/libsdl-org/SDL_image/releases/download/release-3.4.6/SDL3_image-devel-3.4.6-mingw.tar.gz)
  else ()
    set(SDL3IMAGE_URL https://github.com/libsdl-org/SDL_image/releases/download/release-3.4.6/SDL3_image-3.4.6.tar.gz)
  endif ()
  ...
  if (NOT TARGET SDL3_image::SDL3_image)
    ...
    set(SDL3_image_DIR ${SDL3ImageExternal_SOURCE_DIR}/cmake CACHE PATH "Path to SDL3_image source directory" FORCE)
...
if (SDL3PP_ENABLE_MIXER)
  ...
  elseif (WIN32)
    set(SDL3MIXER_URL https://github.com/libsdl-org/SDL_mixer/releases/download/release-3.2.4/SDL3_mixer-devel-3.2.4-mingw.tar.gz)
  else ()
    set(SDL3MIXER_URL https://github.com/libsdl-org/SDL_mixer/releases/download/release-3.2.4/SDL3_mixer-3.2.4.tar.gz)
  endif ()
  ...
  if (NOT TARGET SDL3_mixer::SDL3_mixer)
    ...
    set(SDL3_mixer_DIR ${SDL3MixerExternal_SOURCE_DIR}/cmake CACHE PATH "Path to SDL3_mixer source directory" FORCE)
...
if (SDL3PP_ENABLE_NET)
  ...
  elseif (WIN32)
    if (MSVC)
      set(SDL3NET_URL https://github.com/libsdl-org/SDL_net/releases/download/release-3.2.0/SDL3_net-devel-3.2.0-VC.zip)
    else ()
      set(SDL3NET_URL https://github.com/libsdl-org/SDL_net/releases/download/release-3.2.0/SDL3_net-devel-3.2.0-mingw.tar.gz)
    endif ()
  else ()
    set(SDL3NET_URL https://github.com/libsdl-org/SDL_net/releases/download/release-3.2.0/SDL3_net-3.2.0.tar.gz)
  endif ()
...
if (SDL3PP_ENABLE_TTF)
  ...
  if (NOT TARGET SDL3_ttf::SDL3_ttf)
    ...
    set(SDL3_ttf_DIR ${SDL3TTFExternal_SOURCE_DIR}/cmake CACHE PATH "Path to SDL3_ttf source directory" FORCE)
