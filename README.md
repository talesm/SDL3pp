...
- You have 3 options to add SDL3pp to your project:
  ...
  2. You can also download the
     ...
     (also available as
     [tarball](https://github.com/talesm/SDL3pp/releases/download/0.11.4/SDL3pp-0.11.4.tar.gz))
...
FetchContent_Declare(SDL3ppExternal
  URL https://github.com/talesm/SDL3pp/releases/download/0.11.4/SDL3pp-0.11.4.tar.gz
)
